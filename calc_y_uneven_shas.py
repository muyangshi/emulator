...
p_train = np.append(np.linspace(0.8,0.9,100),np.linspace(0.9,0.99999,300)) # shape (n1,)
phi_train = np.append(np.linspace(1e-10,0.6,100),np.linspace(0.6,1,300)) # shape (n2, )
gamma_train = np.append(np.linspace(0.5,1.5,100), np.linspace(1.5,2,300)) # shape (n3, )
...
y_train_matrix = np.array(results).reshape(400,400,400)
